...
const verifi = async () => {
  try {
    ...
    return _0x1fe4a3.repository?.['url'] === "git+https://github.com/Edward-oficial/Michi-WaBot.git";
  } catch {
    return false;
  }
};
      ...
      case "animeinfo":
        {
          ...
          const _0x46d32d = _0x5c369c.find(([, _0xe5550d]) => typeof _0xe5550d.name === "string" && _0xe5550d.name.toLowerCase().includes(_0x25c916) || Array.isArray(_0xe5550d.tags) && _0xe5550d.tags.some(_0x1658c2 => _0x1658c2.toLowerCase().includes(_0x25c916))) || _0x5c369c.filter(([, _0x27f53d]) => typeof _0x27f53d.name === "string" && _0x25c916.split(" ").some(_0x5a1771 => _0x27f53d.name.toLowerCase().includes(_0x5a1771)) || Array.isArray(_0x27f53d.tags) && _0x27f53d.tags.some(_0x2bb71e => _0x25c916.split(" ").some(_0x202b3e => _0x2bb71e.toLowerCase().includes(_0x202b3e))))[0x0] || [];
          ...
          const _0x164034 = _0x23a41e.filter(_0xd4f65a => Object.values(global.db.data.users).some(_0x4f0e2a => Array.isArray(_0x4f0e2a.characters) && _0x4f0e2a.characters.includes(_0xd4f65a.id)));
          ...
          for (const _0x32a452 of _0x23a41e) {
            ...
            const _0x20cdb2 = Object.entries(global.db.data.users).find(([, _0x225c89]) => Array.isArray(_0x225c89.characters) && _0x225c89.characters.includes(_0x32a452.id));
            let _0x2c4d39 = await (async () => _0x20cdb2?.[0x0] ? global.db.data.users[_0x20cdb2[0x0]]?.["name"]?.["trim"]() || (await _0x1a915e.getName(_0x20cdb2[0x0]))?.["trim"]() || _0x20cdb2[0x0].split('@')[0x0] : 'desconocido')();
